...
$conn = mysqli_connect("localhost","admin_solucian","121212","admin_solucian"); //mysqli_connect("ME LLAMO A MI mismo porque esta dentro del servidor","usuario","contrasena","db a la que nos vamos a conectar")
...
if( isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_r'])) {
  ...
  $password_r = strip_tags($_POST['password_r']); //password repite
...
<head>
  <meta charset="utf-8" />
  <title>Registrarse SOLUCIAN</title>
...
<br>
    <div class="p-v-lg text-center">
      <div >Ya tiene registrado una cuenta? <a ui-sref="access.signin" href="login.php" class="text-primary _600">Entrar</a></div>
    </div>
  </div>
