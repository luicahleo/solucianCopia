...
var client = mqtt.connect("mqtt://solucian.ga", options);//este es el cliente
...
client.on('message', function (topic, message) {
  ...
  if (topic == "values"){
    ...
    var query = "INSERT INTO `admin_solucian`.`data` (`data_temp1`, `data_temp2`, `data_volts`) VALUES (" + temp1 + ", " + temp2 + ", " + volts + ");";
